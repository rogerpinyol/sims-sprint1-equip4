    ...
    <main class="flex flex-col">
      ...
      <div class="p-4 space-y-4">
        ...
        <form method="post" action="/manager/users" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 mb-3 items-start">
          <input required name="name" placeholder="Name" class="input">
          <input required type="email" name="email" placeholder="Email" class="input">
          <input required minlength="6" type="password" name="password" placeholder="Password" class="input">
            ...
            <table class="table text-sm">
              <thead>
                <tr>
                  ...
                  <th class="hidden md:table-cell">Acces.</th>
                  <th>Acciones</th>
                </tr>
              </thead>
              <tbody>
